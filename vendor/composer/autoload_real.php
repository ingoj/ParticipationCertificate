...
class ComposerAutoloaderInit738dc0c59d5cb068de66fc92822764a2
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit738dc0c59d5cb068de66fc92822764a2::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire738dc0c59d5cb068de66fc92822764a2($fileIdentifier, $file);
        }
...
function composerRequire738dc0c59d5cb068de66fc92822764a2($fileIdentifier, $file)
{
