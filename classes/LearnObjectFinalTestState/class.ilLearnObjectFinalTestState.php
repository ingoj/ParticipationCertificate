...
class ilLearnObjectFinalTestState {
	...
	protected int $locftest_crs_obj_id;
	protected string $locftest_crs_title;
	protected int $locftest_objective_id;
	protected string $locftest_objective_title;
	protected int $locftest_test_ref_id;
	protected int $locftest_test_obj_id;
	protected string $locftest_test_title;
	protected int $locftest_percentage;
	protected int $locftest_qpls_required_percentage;
